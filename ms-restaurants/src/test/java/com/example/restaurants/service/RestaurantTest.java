...
import com.example.commons.model.pojo.Restaurant;
import com.example.restaurants.RestaurantApplicationTest;
import com.example.restaurants.mapper.RestaurantMapper;
...
public class RestaurantTest extends RestaurantApplicationTest {
    ...
    void testSyncForHash() {
        ...
        log.info("执行时间：{}", end - start); // 执行时间：131632
    }
    ...
    void testSyncForHashPipeline() {
        ...
        long end = System.currentTimeMillis();
        log.info("执行时间：{}", end - start); // 执行时间：75159
    }
